 ...
 * 同时展示如何进行节点浏览并弹出泡泡
 */
public class CloudSearchDemo extends Activity implements
...
//		LatLng l3 = new LatLng(Latitude,Longtitude);
...
//		mBaidumap.animateMapStatus(u);
	...
	public void nodeClick(View v) {
		...
		// show popup
		popupText = new TextView(CloudSearchDemo.this);
	...
	public void onGetWalkingRouteResult(WalkingRouteResult result) {
		if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
			Toast.makeText(CloudSearchDemo.this, "抱歉，未找到结果", Toast.LENGTH_SHORT)
					.show();
		}
